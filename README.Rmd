...
* Time to withdrawal of consent (as percentage or number of trial participants with withdrawal of informed consent)
...
Bortkiewicz's data on the numbers of Prussian cavalry officers kicked to death by horses [@Bortkiewicz1898] can be used to illustrate the method.
```{r}
data("cavalryDeaths")
